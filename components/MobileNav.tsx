...
const MobileNav = () => {
  ...
  useEffect(() => {
    ...
    } else if (!navShow && navRef.current) {
          ...
          <Dialog as="div" onClose={onToggleNav}>
            ...
            >
              <DialogPanel className="fixed top-0 left-0 z-70 h-full w-full bg-white/95 duration-300 dark:bg-gray-950/98">
                ...
                <button
                  className="hover:text-primary-500 dark:hover:text-primary-400 fixed top-10 right-7 z-80 h-8 w-8 text-gray-900 dark:text-gray-100"
